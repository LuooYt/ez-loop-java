...
class SSEClient {
    ...
    /**
     * 注册事件监听器。
     * @param {string} event - 事件名：token, tool_use, thinking, activity, ask_user, permission, compaction, complete, error
    ...
    connect(sessionId, message) {
        ...
        // 注册所有事件
        const eventTypes = ['token', 'tool_use', 'thinking', 'activity', 'ask_user',
                            'permission', 'compaction', 'complete', 'error'];

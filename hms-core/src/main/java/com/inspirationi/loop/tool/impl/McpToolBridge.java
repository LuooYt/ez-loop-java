...
import com.inspirationi.loop.mcp.McpException;
 ...
 *   <li>实现 {@link Tool} 接口，使其可注册到 {@link ToolRegistry}</li>
...
public class McpToolBridge implements Tool {
    ...
    /**
     * 返回桥接后的本地工具名称（格式：mcp__{serverName}__{toolName}）。
     */
    @Override
    public String name() {
        return bridgedName;
    ...
    /**
     * 返回工具描述，以 [MCP:服务器名] 前缀标明工具来源，便于 LLM 识别。
     */
    @Override
    ...
    /**
     * 返回 MCP 工具定义的输入 JSON Schema 字符串。
     */
    @Override
